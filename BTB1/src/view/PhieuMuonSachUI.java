...
import service.implement.PhieuMuonSachServiceImplement;

public class PhieuMuonSachUI extends javax.swing.JFrame {

    private iPhieuMuonSachService listPhieuMuonSach = new PhieuMuonSachServiceImplement();
    private DefaultTableModel dtm;
    private DefaultComboBoxModel dcbm;

    public PhieuMuonSachUI() {
        initComponents();
        addComBox();
    }
    ...
    private void addComBox() {
        ...
        list.add("WER");
        list.add("MARKETING");
        dcbm = (DefaultComboBoxModel) cbbBoMon.getModel();
    ...
    private void loadData() {
        ArrayList<PhieuMuonSach> list = listPhieuMuonSach.getList();
        dtm = (DefaultTableModel) this.tblPhieuMuonSach.getModel();
        dtm.setRowCount(0);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        PhieuMuonSach phieuMuonSach = insert();
        Boolean checkAdd = listPhieuMuonSach.insert(phieuMuonSach);
        if (checkAdd) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        this.listPhieuMuonSach.delete(row);
        this.clearForm();
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ArrayList<PhieuMuonSach> list = this.listPhieuMuonSach.getList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhieuMuonSachUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhieuMuonSachUI().setVisible(true);
            }
        });
    }
